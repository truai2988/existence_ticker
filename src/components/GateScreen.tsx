        ...
        {!isOpening && (
          ...
          >
            ...
            <button
              ...
              className="group relative px-12 py-5 bg-transparent border border-[#E5E5E5] rounded-xl tracking-[0.3em] text-xs font-sans font-medium uppercase text-[#777777] hover:text-[#2D2D2D] transition-all duration-700 overflow-hidden"
            >
