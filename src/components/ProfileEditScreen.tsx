        ...
        <div className="fixed inset-0 z-[70] bg-[#F9F8F4]/80 backdrop-blur-3xl flex flex-col animate-fade-in font-sans w-full h-full">
                    ...
                    <div className="max-w-2xl mx-auto px-6 py-4 md:py-8 flex items-center justify-between flex-nowrap gap-2">
                        <div className="flex items-center gap-3 min-w-0">
                            <button
                                ...
                                className="p-2 -ml-2 text-slate-500 hover:text-slate-600 transition-colors active:scale-95"
                            >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar w-full">
                ...
                <div className="bg-white/50 backdrop-blur-3xl p-6 rounded-[2rem] border border-transparent shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            {previewUrl ? (
                                ...
                                <XCircle size={16} className="text-slate-500 shrink-0" strokeWidth={2} />
                            )}
                            <span className={`text-[13px] tracking-wide ${previewUrl ? 'text-amber-900 font-medium' : 'text-slate-500'}`}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className={`text-[13px] tracking-wide ${bio.length >= 30 ? 'text-amber-900 font-medium' : 'text-slate-500'}`}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className={`text-[13px] tracking-wide ${(links.x || links.instagram || links.website) ? 'text-amber-900 font-medium' : 'text-slate-500'}`}>
                    ...
                    {/* Basic Info Group */}
                    <div className="space-y-4">
                        <h3 className="text-xs sm:text-xs font-bold text-slate-500 uppercase tracking-[0.2em] ml-2" style={{fontFamily: "'Noto Serif JP', serif"}}>{MESSAGES.PROFILE.BASIC_INFO}</h3>
                        <div className="bg-white/50 backdrop-blur-3xl p-6 rounded-[2rem] border border-transparent shadow-sm space-y-5 transition-shadow">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full p-4 bg-white/60 border border-transparent rounded-2xl text-slate-800 font-medium focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm transition-all text-base placeholder:text-slate-500"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select 
                                        ...
                                        className="w-full p-4 bg-white/60 border border-transparent rounded-2xl text-slate-800 font-medium appearance-none focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm transition-all text-base"
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`py-3 px-2 rounded-2xl text-sm font-bold transition-all border ${
                                                gender === opt.value
                                                    ...
                                                    : "bg-white/40 text-slate-500 border-transparent shadow-sm hover:bg-white/60 hover:shadow-md"
                                            }`}
                                        >
                                            {opt.label}
                                        </button>
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    className="w-full p-4 bg-white/60 border border-transparent rounded-2xl text-slate-800 text-base focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm transition-all resize-none h-24 placeholder:text-slate-500"
                    ...
                    {/* Location Group */}
                    <div className="space-y-4">
                        <h3 className="text-xs sm:text-xs font-bold text-slate-500 uppercase tracking-[0.2em] ml-2 flex items-center gap-1" style={{fontFamily: "'Noto Serif JP', serif"}}>
                            <MapPin size={12} />
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select 
                                            ...
                                            className="w-full p-4 bg-white/60 border border-transparent rounded-2xl text-slate-800 text-base font-medium appearance-none focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm transition-all"
                                        >
                                            <option value="">{MESSAGES.PROFILE.AGE_UNSELECTED}</option>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select 
                                            ...
                                            className="w-full p-4 bg-white/60 border border-transparent rounded-2xl text-slate-800 text-base font-medium appearance-none focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm disabled:opacity-30 transition-all"
                        ...
                        <div className="bg-white/50 backdrop-blur-3xl p-6 rounded-[2rem] border border-transparent shadow-sm space-y-5 transition-shadow">
                            <div className="flex items-center gap-3">
                                ...
                                <input 
                                    ...
                                    className="flex-1 min-w-0 p-4 bg-white/60 border border-transparent rounded-2xl text-slate-700 text-base font-mono focus:outline-none focus:bg-white/80 focus:shadow-md shadow-sm transition-all placeholder:text-slate-500"
                            ...
                            <div className="flex items-center gap-3">
                                <span className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 shrink-0 shadow-sm">
                                    <LinkIcon size={16} />
                                </span>
                                <input 
                                    type="text" 
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white/50 backdrop-blur-3xl p-6 rounded-[2rem] border border-transparent shadow-sm space-y-5 transition-shadow">
                                <div>
                                    ...
                                    <div className="w-full p-4 bg-white/40 border border-transparent shadow-sm rounded-2xl text-slate-500 text-base font-mono">
                                        {user.email}
                                    </div>
                                ...
                                <button
                                    ...
                                    className="w-full p-4 bg-white/40 border border-transparent rounded-2xl text-slate-600 text-sm font-bold shadow-sm hover:shadow-md hover:bg-white/60 transition-all flex items-center justify-center gap-2"
                                >
                                    <Mail size={16} />
